...
if (new){
  ...
  # now save!
  save.image(file = '../data/derivatives/acc_mod-fxb-bsubrfx/acc_mod-fxb_bsubrfx.Rda')
  
} else {
  
  load(file = '../data/derivatives/acc_mod-fxb-bsubrfx/acc_mod-fxb_bsubrfx.Rda')
}
...
if (verbal){
  ...
  pdf(file='../data/derivatives/acc_mod-fxb-bsubrfx/ps_and_chains.pdf')
    plot(fxb_bsubrfx)
  dev.off()
  ...
  pdf(file='../data/derivatives/acc_mod-fxb-bsubrfx/pp_check.pdf')
    pp_check(fxb_bsubrfx) # looks pretty good
  dev.off()
  ...
  pdf(file='../data/derivatives/acc_mod-fxb-bsubrfx/predobs_resid.pdf')
