...
authors:
  ...
  - name: Paul  E. Dux
    ...
    location: St. Lucia, QLD
abstract: |
  Given experience in cluttered but stable visual environments, our eye-movements adapt to form personal, or stereotyped, routines that frequent the locations most likely to offer task-relevant information, yet disambiguate between highly comparable task-environments - such as searching for ones keys at home or in the office. Although theoretical insights and empirical data suggest that both dopamine function and mindfulness may be important modulators of the formation and maintenance of such stereotyped routines, quantification of their joint impact remains to be explored in healthy humans. We addressed these questions by combining a pharmacological manipulation with a novel paradigm. Over two sessions, participants observed a gaze contingent display comprised of a 4 x 4 grid of doors, and were instructed to use their eyes to open doors in order to find hidden animal targets. Within each session, doors appeared in either one of two colours, and participants were told that depending on the colour, the animals would have different places they preferred to hide. We derived measures for how well participants learned the target locations overall (accuracy), how stereotypical was their deployment of eye-movement routines (stereotypy), and how well eye-movements disambiguated the task-environments (task-relevant accuracy). Participants received either Maladopar (dopamine precursor) or placebo (vitamin C) across the 2 sessions, under double-blind conditions. Dopamine and trait mindfulness (assessed by questionnaire) interacted to influence both accuracy and stereotypy. Increasing dopamine improved accuracy and reduce stereotypy for individuals scoring high for mindfulness, and induced the opposite pattern for low mindfulness scorers. Dopamine also decreased task-relevant accuracy across all levels of mindfulness. Overall, the data suggest that mindfulness modulates the impact of increased dopamine on the formation of stereotyped eye-movement routines; individuals scoring low for mindfulness may settle on suboptimal routines at the expense of learning. Furthermore, increasing dopamine increases the likelihood of confusion between task-relevant behaviours, regardless of mindfulness state. These findings provide a link between non-human and human models regarding the influence of dopamine on the formation of task-relevant eye-movements, and provide novel insights into modulating factors when humans use experience to build adaptive repertoires.  
...
Given stable environmental contingencies, it is adaptive for an organism to develop routine ways of performing tasks requiring multiple responses. Dopamine signalling is assumed to play a key role in the neural computations that underlie the formation of task-relevant routines. There is a large body of evidence showing that dopaminergic midbrain neurons encode reward prediction errors, a teaching signal assumed to drive the selection of actions in relation to their success in maximising reward. A comparable signal, marking the difference between the expected and actual effort required for macaques to attain reward under a free-viewing visual search task has been shown to predict the formation of eye-movement routines that become stereotyped over multiple task sessions, and is assumed to be encoded via firing rates in the caudate nucleus, which are modulated by dopamine release [@nakamuraRoleDopaminePrimate2006a; @mclennanActionDopamineNeurones1967]. Moreover, there exists a large body of evidence from rodent and macaque models suggesting that increased dopamine availability speeds the transition from goal-directed to habitual behaviour, the latter of which is assumed to underpin behavioural routines. Although the role of dopamine in the formation of behavioural routines appears to be well established, how dopamine availability modulates the formation of behavioural routines in healthy humans remains an open question. 

For behavioural routines to be adaptive, it is also required that the correct routine is implemented for the current task, despite the co-occurrence of multiple situational features between tasks. Dopamine signalling is assumed to play a modulatory role in the activation of task-relevant behavioural repertoires on the basis of relevant situational cues. Patients with Parkinson's Disease consistently show deficits switching between simple stimulus-response tasks, as do healthy participants who have been administered L-Dopa, a dopamine precursor that increases dopamine availability. Such findings have been theoretically accounted for by assuming that tonic dopamine levels signal uncertainty regarding the likelihood of being in a specific task-state, given sensory inputs [Friston]. The current assumptions are based on evidence from tasks involving single responses that are highly constrained - i.e. that are correct given the current sensory input. In contrast, routine behaviours are often formed from a self-selected set of many possible behaviours. As with the formation of task-relevant routines, the quantitative mapping between dopamine availability and the ability to switch between task-relevant routines is currently unknown for healthy human participants.

A critical, but less frequently discussed component of the processes underlying routine performance is the accurate representation of task-relevant cues and actions, presumably encoded by cortex and relayed to striatum for reinforcement [cite Killcross, Ashby, Bar-Gaid]. THE CONSEQUENCE OF INNACCURACY HERE. Perhaps surprisingly, both empirical and theoretical insights point to a role for mindfulness in the accuracy of task-representations. Mindfulness is defined as a mental state of not being preoccupied with events other than current sensory and internal inputs, and as such is well-placed to promote the accuracy of representations of cues, actions and outcomes. In support of this notion, mindfulness practice has been associated with increased indices of error monitoring during cognitively challenging tasks as assessed using electroencephalography [Heleen], and with greater sensitivity to dynamics in operant reinforcement contingencies. Theoretically and within the same framework used to explain the function of tonic dopamine, mindfulness has been linked to the appropriate weighting of relevant sensory signals, over non-sensory or non-relevant signals, for the current task-state. How dopamine and mindfulness act together to influence task-relevant routine formation is yet to be characterised.
