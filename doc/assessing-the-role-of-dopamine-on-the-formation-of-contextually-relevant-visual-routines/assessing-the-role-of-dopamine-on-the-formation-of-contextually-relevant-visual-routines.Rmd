...
We investigated the impact of trait mindfulness and dopamine function on the learning of task-relevant behaviour sets, and on the stereotypy of their deployment. Participants used their eyes to open doors in a gaze-contingent display, the colour of which signalled likely target locations. Mindfulness modulated the impact of L-Dopa on performance. Increasing mindfulness was associated with a positive impact of L-Dopa on accuracy, and a negative impact of L-Dopa on stereotypy. L-Dopa negatively impacted setting-accuracy regardless of trait mindfulness. These results quantify for the first time, how increasing systemic dopamine availability induces a trade-off between accuracy and stereotypy. Moreover, increasing dopamine availability increases the likelihood of behavioural confusion between settings. These findings carry implications for our theoretical understanding of how the brain establishes and switches between task-relevant behavioural routines, which we outline below.

What could cause mindfulness to modulate the impact of dopamine availability on accuracy and stereotypy? Our measure of overall accuracy charted how often eye-movements were directed to doors that were possible target locations for either setting (rewarded), relative to doors where targets were never found (non-rewarded). For stereotypy, the interactive influence of mindfulness and L-Dopa was found to be larger when accounting for setting-accuracy, suggesting that dopamine availability served to promote behavioural routines that contained erroneous door-selections in low mindfulness scorers. As mindfulness and dopamine interacted to increase accuracy and reduce stereotypy, it is unlikely that the current results can be attributed to a dopamine-induced increase in random exploration in low-mindfulness individuals [ref k-armed bandit], as this would cause both accuracy and stereotypy to decrease with mindfulness scores. Collectively, this set of findings shows that something is changing in the brain across levels of mindfulness that impacts how dopamine influences the formation of behavioural policies for a given task-setting.

This then begs the question of what could be changing across levels of mindfulness to induce this differential impact of dopamine availability on accuracy and stereotypy. It could be that trait mindfulness modulates the impact of dopamine signals during the formation of incentive salience - the association of sensory inputs to their reward significance [@berridgeWhatRoleDopamine1998]. These results accord with previous findings that mindfulness interventions may act to promote more consistent neural responses to the attainment of reward, as assessed by changes in the BOLD signal, regardless of the predictability of that reward [@kirkShorttermMindfulnessPractice2019]. Thus mindfulness may act in the current task to promote a steady representation of possible target locations even when a location has already been searched prior to target onset, potentially causing surprise. Specifically, mindfulness may promote the use of dopamine to appropriately tag relevant potential target locations in a manner that is resistant to local statistical variability in target onset.

How could mindfulness and dopamine act in concert to modulate encoding of target-relevant locations? Mindfulness has been associated with maintenance of present information in current mental experience [@laukkonenManyOneMeditation2021a] at the expense of information related to the non-present, such as ruminating on previous experiences [@bucknerSelfprojectionBrain2007]. It has been separately proposed that the relaying of sensory-response information from cortex to striatum reflects a process of reinforcement-driven dimensionality-reduction [@bar-gadReinforcementdrivenDimensionalityReduction2000a; beyelerNeuralCorrelatesSparse2019a]. If low mindfulness causes current events to be represented with low fidelity, this could induce noise into the information that is relayed from  cortex to the striatum. This could in-turn promote vulnerability towards developing suboptimal policies under conditions of increased dopamine availability, as increased dopamine may induce stronger entrenchment of noisy inputs during data reduction. This interpretation accords with recent theoretical assertions that working memory, a construct related to the current contents of mental experience, is a critical component of reinforcement learning [@yooHowWorkingMemory2022]. 
This account may explain why individuals low in mindfulness showed both higher stereotypy and lower accuracy with increased dopamine availability. The output activity of dopaminergic cells in macaque caudate nucleus have been shown to modulate eye-movements towards reward-related stimuli [@kunimatsuCaudalPartPutamen2019; @amitaOptogeneticManipulationValuecoding2020b; @nakamuraRoleDopaminePrimate2006], and neural activity in this region is sensitive to the cost of stereotypical eye-movement sequences in the macaque brain [@desrochersOptimalHabitsCan2010, @desrochersHabitLearningNaive2015], i.e. how long a sequence was relative to the expected sequence used to attain reward. If the consequence of low mindfulness is the relay of imprecise representations of current behaviours from cortex to striatum, this would presumably challenge the computation of cost-functions used to guide effort made in pursuit of rewards, potentially motivating convergence to a suboptimal strategy. These results therefore expand our understanding of how dopamine signalling may drive habitual behavioural sequences, by demonstrating the importance of behaviour-trait qualities that pertain to awareness of the current moment.

This interpretation is based on assumptions that L-Dopa impacted phasic dopamine signalling in the striatum [@willuhnExcessiveCocaineUse2014], or up-weighted cortical-striatal synaptic plasticity via a paracrine effect [@albinMissingShortLong2017]. There are theoretical frameworks that posit a role for tonic dopamine in the deployment of contextually relevant sequences. It has been proposed that tonic dopamine signals the precision of an agent's internal model of actions and sensory consequences [@fitzgeraldDopamineRewardLearning2015; @fristonDopamineAffordanceActive2012], assuming a positive monotonic relationship between dopamine and precision. Mindfulness practice has also been associated to the modulation of comparable precision parameters [@laukkonenManyOneMeditation2021a]. Interpreted via this lens, the current findings suggest a nuanced relationship between variability in internal models and dopaminergic precision signals; it is possible that increased tonic dopamine can induce overestimates of precision, or that the relationship between tonic dopamine and precision signalling is not necessarily monotonic. 

Indeed, the finding that L-Dopa served to reduce setting-accuracy, regardless of mindfulness state, suggests that our results may not be explainable under the assumption of a monotonic relationship between tonic dopamine and precision signalling, as such lapses would presumably be induced in-part by variability in certainty over the current task-set. Setting-accuracy reduced with dopamine availability, increasing the probability of a door-selection from the wrong behavioural set. These findings complement others showing that ingestion of a D2/D3 agonist promotes task-switching impairments [@mehtaImpairedSetshiftingDissociable2004]. The current data suggest that L-Dopa either acted to reduce certainty over what is the relevant task-set, or may have induced hyper-crediting of target-door locations so that they were competitive for selection within each task-set. This interpretation fits with previous work showing that the output of dopaminergic neurons from songbird Area X may act to excite the range of behaviours that are appropriate for a given task-set [@budzilloDopaminergicModulationBasal2017]. It is, however, also possible, that dopamine availability prohibited the learning of each context, rather than causing context confusion. We shall seek to disambiguate between these possibilities in future work.

The current work is not without limitations. A difference was found in mean BVP between the L-Dopa and placebo, suggesting more general physiological differences between the sessions. However, participants were not able to detect whether they had received L-Dopa or placebo above what would be expected by chance. Therefore, the physiological changes appeared to not be subjectively detectable, lowering the likelihood that they impacted the results. Note that although the power of our blinding test was lowered owing to missing data, the remaining N was comparable to sample sizes from previous investigations into the impact of dopaminergic pharmacological intervention on decision-making, that employed comparable blinding tests [@leowDopamineIncreasesAccuracy2023a; @pineDopamineTimeImpulsivity2010; @wunderlichDopamineEnhancesModelBased2012]. 

Although accuracy and stereotypy theoretically need not be correlated, we did find a moderate positive correlation between the two measures. Critically, the modulatory influence of mindfulness and dopamine on stereotypy was found to be larger after accounting for accuracy. Furthermore, accuracy and stereotypy were at antithesis to each other with regard to the effects of mindfulness and dopamine availability. Nonetheless, further work should be done to verify the dissociable impact of dopamine and mindfulness on these two aspects of performance. We shall seek to achieve this in future studies by controlling task parameters to maintain accuracy, while examining modulations to stereotypy. 
