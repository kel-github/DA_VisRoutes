...
Although accuracy and stereotypy theoretically need not be correlated, we did find a moderate positive correlation between the two measures. Critically, the modulatory influence of mindfulness and dopamine on stereotypy was found to be larger after accounting for accuracy. Furthermore, accuracy and stereotypy were at antithesis to each other with regard to the demonstrated impacts of mindfulness and dopamine availability. Nonetheless, further work should be done to verify the dissociable impact of dopamine and mindfulness on these two aspects of performance. We shall seek to achieve this in future studies by controlling task parameters to maintain accuracy, while examining modulations to stereotypy. 


250
wider speculations 
- relationship to keeping on track, goal relevant behaviour system - computation of cost function, and relationship to clinical syndromes

- mindfulness vs BIS
- D1 & D2 - https://www.sciencedirect.com/science/article/pii/S0896627318306755
- Beyond basal ganglia

 output activity of dopaminergic cells in macaque caudate nucleus have been shown to modulate eye-movements towards reward-related stimuli [@kunimatsuCaudalPartPutamen2019; @amitaOptogeneticManipulationValuecoding2020b; @nakamuraRoleDopaminePrimate2006], and neural activity in this region is sensitive to the cost of stereotypical eye-movement sequences in the macaque brain [@desrochersOptimalHabitsCan2010, @desrochersHabitLearningNaive2015], i.e. how long a sequence was relative to the expected sequence used to attain reward. If the consequence of low mindfulness is the relay of imprecise representations of current behaviours from cortex to striatum, this would presumably challenge the computation of cost-functions used to guide effort made in pursuit of rewards, potentially motivating convergence to a suboptimal strategy. These results therefore expand our understanding of how dopamine signalling may drive habitual behavioural sequences, by demonstrating the importance of behaviour-trait qualities that pertain to awareness of the current moment.
