...
Dis: We investigated the impact of trait mindfulness and dopamine availability on the learning of task-relevant behaviour sets, and on the stereotypy of their deployment. 
Humans often develop stereotypical ways of performing tasks, given sufficient exposure to a consistent task environment; for example, most people follow their own routine to search their home for their keys. As well as learning and developing task-relevant routines, humans are regularly able to not mix-up task routines despite striking similarities in behaviours and task-settings; for example, not confusing the search for keys with the behaviours required to instead search for a lost hat. Despite a growing awareness that dopaminergic signalling in cortical-striatal circuitry 

likely underpins the brain's capacity to form and deploy task-relevant routines [birds, monkeys], an understanding of how dopamine and  [NEED A WAY TO LEAD WITH WHAT MINDFULNESS DOES].

Learning a task-relevant routine - something we do - general intro - 80

140
Striatal signals and task relevant-routines; what we know [birds and monkeys], but presumably part of a wider system that involves the 
relay of task-information from cortex to striatum. 

150
Factors that modulate this process remain to be investigated.
e.g. dopamine Dopamine is important - precision vs inflated signalling 

150
Relationship of mindfulness to task-relevant representations (steady but what is the content) 
and the relationship of cortical-striatal comms and reinforcement to task reps 
unknown if mindfulness impacts this cycle

Possible directions of predictions - 80

Context - actor/critic - birds. 150
Within a stable context: Sequence/stereotypy - Graybiel. 150
Dopamine and mindfulness - obvs, plus Montague, and I guess Reuben 200
Goal to assess the trade-off in one study.
...
What could cause mindfulness to modulate the impact of dopamine availability on accuracy and stereotypy? We hypothesise that mindfulness may impact the quality of task-behaviour representations that are relayed between the cortex and striatum during the computation of incentive salience [e.g. @berridgeWhatRoleDopamine1998, @bar-gadReinforcementdrivenDimensionalityReduction2000a; @beyelerNeuralCorrelatesSparse2019a]. Lower mindfulness has been associated with lower explicit awareness of the current contents of cognitive states [@sandved-smithComputationalPhenomenologyMental2021; @laukkonenManyOneMeditation2021a; @lutzEpistemicPragmaticValue2019; @@bucknerSelfprojectionBrain2007]; the consequence of which may be lower fidelity representations of currently performed behaviours. Concurrently, L-Dopa may inflate phasic dopamine responses [@willuhnExcessiveCocaineUse2014], possibly elevating positive reinforcement signals. We propose that the consequence of this combination is an entrenchment of an imprecise model of the behaviours that led to successful outcomes. This interpretation accords with previous theoretical accounts of the nature of striatal-cortical interactions; it has been proposed that the relay of information from cortex to striatum reflects a process of reinforcement-driven dimensionality-reduction [@bar-gadReinforcementdrivenDimensionalityReduction2000a; @beyelerNeuralCorrelatesSparse2019a], where the striatum compresses cortical information and tags statistically reliable patterns with incentive salience. Accordingly, mindfulness may modulate the information that is relayed from cortex, thereby impacting the probability that both spurious and successful behaviours load onto latent factors that are tagged as motivationally significant. 

#########
This interpretation, that low mindfulness corresponds to inaccuracy in the cortical representations that are relayed to striatum, accords with recent theoretical assertions that working memory, a construct related to the current contents of mental experience, is a critical component of reinforcement learning [@yooHowWorkingMemory2022]. Indeed,trait mindfulness has been positively associated with performance on a range of cognitive tasks, including those tapping working memory function [@jhaDoesMindfulnessTraining2019; @anichaCognitiveViewTrait2012; @jaiswalBetterCognitivePerformance2018]. 
Here we provide support for this framework by showing that behaviour-trait levels of mindfulness, which itself has been associated with performance and with recent findings that mindfulness interventions may act to promote less variable neural responses to the attainment of reward, as assessed by changes in the BOLD signal [@kirkShorttermMindfulnessPractice2019]. Specifically, individuals participating in a mindfulness intervention programme show attenuated BOLD responses in the putamen, relative to controls, when reward delivery violates expectations. The same group also shows increased BOLD responses in cortical regions assumed to encode stimulus driven responses, invariant to stimulus probability. One interpretation of these findings is that mindfulness motivates a steadfast encoding of the events that led to successful outcomes, that is less impacted by variability in stimulus and reward information.
########


This account can also inform our understanding of how the brain develops task-relevant routines, particularly when considered in conjunction with findings from non-human primate studies. The output activity of dopaminergic cells in macaque caudate nucleus have been shown to modulate eye-movements towards reward-related stimuli [@kunimatsuCaudalPartPutamen2019; @amitaOptogeneticManipulationValuecoding2020b; @nakamuraRoleDopaminePrimate2006], and neural activity in this region is sensitive to the cost of stereotypical eye-movement sequences in the macaque brain [@desrochersOptimalHabitsCan2010, @desrochersHabitLearningNaive2015], i.e. how long a sequence was relative to the expected sequence used to attain reward. If the consequence of low mindfulness is the relay of imprecise representations of current behaviours from cortex to striatum, this would presumably challenge the computation of cost-functions used to guide effort expended in pursuit of rewards, motivating convergence to a suboptimal strategy. These results therefore expand our understanding of how dopamine signalling may drive habitual, and even superstitious, behavioural routines. Specifically, behaviour-trait qualities that modulate awareness of the current moment may impact the fidelity of task-behaviour representations, increasing vulnerability that superfluous actions are tagged as significant for successful outcomes. 
