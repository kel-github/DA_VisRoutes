...
1500 words
SUMMARY: 150
We investigated the impact of trait mindfulness and dopamine function on the learning of multiple task-relevant behaviour sets, and on the stereotypy of their deployment. Participants used their eyes to open doors in a gaze-contingent display, the colour of which signalled likely target locations. Mindfulness modulated the impact of L-Dopa on performance. Increasing mindfulness was associated with a positive impact of L-Dopa on accuracy, and a negative impact of L-Dopa on stereotypy. L-Dopa negatively impacted setting-accuracy regardless of trait mindfulness. These results quantify for the first time, how increasing systemic dopamine availability induces a trade-off between accuracy and stereotypy. Moreover, increasing dopamine availability increases the likelihood of behavioural confusion between settings. These findings carry implications for recent theories regarding how the brain establishes and switches between task-relevant behavioural routines, which we outline below.

Mindfulness - 
What could cause mindfulness to modulate the impact of dopamine availability on accuracy and stereotypy? Our measure of overall accuracy charted how often eye-movements were directed to doors that were possible target locations (rewarded), relative to doors where targets were never found (non-rewarded). For stereotypy, the interactive influence of mindfulness and L-Dopa was found to be larger when accounting for setting-accuracy, suggesting that dopamine availability served to promote behavioural routines that contained erroneous door-selections in low mindfulness scorers. As mindfulness and dopamine interacted to increase accuracy and reduce stereotypy, it is unlikely that the current results can be attributed to a dopamine-induced increase in random exploration in low-mindfulness individuals [ref k-armed bandit], as this would cause both accuracy and stereotypy to decrease with mindfulness scores. Collectively, this set of findings shows that something is changing in the brain across levels of mindfulness that impacts how dopamine influences the formation of behavioural policies for a given task-setting.

WHAT IS CHANGING? 
150 - incentive salience - quality of information

Cost function - Graybiel work 150
5. they are learning, but they have settled on a suboptimal policy, that is good enough (Brett's learning literature)

Phasic dopamine responses - alternate is the dopamine/precision hypothesis 150

Which leads us to contextual accuracy 150

 The relationship of the brain's dopamine availability to this process appears, from the current data, to be dependent on trait mindfulness. 

Interpretation of mechanisms.125
Learning: high mindfulness -> reward signals were effective in shaping the correct behaviour - attention paid to the task set, and what should be rewarding is ambiguated well from other behaviours (appropriate crediting - actor critic framework - critic). Montague - mindfulness - prediction errors reduced - better response to reward stimuli.

Low mindfulness could therefore be hampered by either a failure to credit something in memory, or may have failed to maintain a representation of their actions that they could appropriately credit (actor). Or, an over-generalisation of crediting of actions. Information provision for compression - see Niv review paper for discussion of the studies. these interpretations suggest L-Dopa and mindfulness may have impacted phasic dopamine responses. 125

STEREOTYPY 250
Learning and stereotypy - 
Stereotypy -
1. low mind = low acc + high stereo

6. This could be due to crediting outweighing other functions, such as computing energetic cost for
trying all the doors (could be 2 sides of the same coin).
If Graybiel paper isn't here then it should be
https://www.sciencedirect.com/science/article/pii/S0896627315006418
https://www.pnas.org/doi/abs/10.1073/pnas.1013470107
Stereotypy: fits with mindfulness views of clinical syndromes: https://www.sciencedirect.com/science/article/pii/S1697260023000170
Might be a strategy to improve representation: https://www.sciencedirect.com/science/article/pii/S0896627322000617
LDopa reduces peserveration of choice in PD patients: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3376711/
Or, could be due to insufficient precision in 
a context parameter - i.e. not updating based on changes to the world. Friston precision - tonic - but not as previously assumed.
Greater mindfulness = better at reversal learning https://www.nature.com/articles/s41598-018-24001-1 - greater mindfulness, bet

SETTING ACCURACY - 250
Contextual accuracy - the data suggest that over-crediting may up-weight actions that lead to successful outcomes more than upweighting all actions. i.e. increased dopamine meant that all participants were likely to select doors from the wrong context. We know they were more likely to select doors from the wrong context, cos control analysis. This suggests that increasing dopamine either reduces context specificity - i.e. how sure the system is in any given context (e.g. Friston stuff, Context RL model), or that dopamine causes hyper-crediting of actions that have lead to successful outcomes, making them more likely to break through in other, similar contexts.
https://direct.mit.edu/jocn/article/34/8/1307/111231/Hierarchical-Reinforcement-Learning-Sequential Hierarchal RL
https://www.pnas.org/doi/abs/10.1073/pnas.1611146114
Can cite Friston here to say that the hypothesised relationship between increased tonic dopamine and precision is not as monotonic as previously assumed.
