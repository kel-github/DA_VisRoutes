...
There are existent theoretical frameworks that guide hypotheses regarding how dopamine availability and mindfulness may jointly confer influence on the formation and deployment of task-relevant routines. 

Dopamine signalling is assumed to underpin the computation of incentive salience; the process of associating action policies with their expected reward values [@berridgeWhatRoleDopamine1998a; @ikemotoRoleNucleusAccumbens1999; @salamoneMotivationalViewsReinforcement2002], whereas mindfulness has been associated with greater sensitivity to dynamics in reinforcement schedule contingencies [@reedFocusedattentionMindfulnessIncreases2023; @chenEffectBriefMindfulness2023a], suggesting [goal vs dumb]? 

Dopamine signalling [@fristonDopamineAffordanceActive2012; @fitzgeraldDopamineRewardLearning2015] and mindfulness [@lutzEpistemicPragmaticValue2019; @laukkonenManyOneMeditation2021] have each been associated with the precision, or variability, in inferences regarding predicted future states. According to this view, increasing dopamine availability should instil false inference regarding which actions led to rewarding outcomes [@fitzgeraldDopamineRewardLearning2015], leading to suboptimal behaviour; 
