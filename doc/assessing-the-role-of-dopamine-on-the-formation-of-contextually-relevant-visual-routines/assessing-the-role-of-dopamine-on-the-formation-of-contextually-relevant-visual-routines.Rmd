...
General high-level description of relevant behaviours of interest.

This is a learning problem. Theoretical assumptions are that we have successful outcomes and we update our representations to tag them with incentive salience. However, we vary wildly in our ability to come up with good routines (cite clinical) and a deeper theoretical understanding is required.

Two seemingly disparate but potentially deeply related factors are dopamine availability and mindfulness. Demonstrate how they are each thought to be important and how they are potentially linked theoretically.
