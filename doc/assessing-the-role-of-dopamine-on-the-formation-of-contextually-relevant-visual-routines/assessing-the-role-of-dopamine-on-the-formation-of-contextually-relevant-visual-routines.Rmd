...
Having established the best model to account for the data, we next determine the influence of DA and mindfulness on accuracy by making inference over the resulting parameters. DA reduced contextual accuracy; the log-odds of performing a contextual accurate target door selection increased in the placebo session (mean log odds = `r sprintf("%1.2f", cacc_results$fixed["drugplacebo","Estimate"])`, 95% CI[`r sprintf("%1.2f", cacc_results$fixed["drugplacebo","l-95% CI"])`, `r sprintf("%1.2f", cacc_results$fixed["drugplacebo","u-95% CI"])`). 

In demonstration that participant learned to make contextually accurate target door locations over the course of the sessions, contextual accuracy reliably increased over blocks (mean log odds = `r sprintf("%1.2f", cacc_results$fixed["b","Estimate"])`, 95% CI[`r sprintf("%1.2f", cacc_results$fixed["b","l-95% CI"])`, `r sprintf("%1.2f", cacc_results$fixed["b","u-95% CI"])`, Fig XX). Mindfulness did not have a reliable impact on contextual accuracy (mean log odds = `r sprintf("%1.2f", cacc_results$fixed["m","Estimate"])`, 95% CI[`r sprintf("%1.2f", cacc_results$fixed["m","l-95% CI"])`, `r sprintf("%1.2f", acc_results$fixed["m","u-95% CI"])`, Fig XX). 
