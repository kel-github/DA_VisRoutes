...
We next determined the influence of dopamine and mindfulness on setting-accuracy by making inference over the resulting model parameters (see Fig \ref{fig:caccfig}). Dopamine reduced setting accuracy; accuracy was on average `r sprintf("%1.2f", overall_acc_by_drug$p[overall_acc_by_drug$drug == "levodopa"])` (95% CI [`r sprintf("%1.2f", overall_acc_by_drug$lower[overall_acc_by_drug$drug == "levodopa"])`, `r sprintf("%1.2f", overall_acc_by_drug$upper[overall_acc_by_drug$drug == "levodopa"])`]) for the dopamine session, and `r sprintf("%1.2f", overall_acc_by_drug$p[overall_acc_by_drug$drug == "placebo"])` (95% CI [`r sprintf("%1.2f", overall_acc_by_drug$lower[overall_acc_by_drug$drug == "placebo"])`, `r sprintf("%1.2f", overall_acc_by_drug$upper[overall_acc_by_drug$drug == "placebo"])`]) for the placebo session. The log-odds of selecting a target door that was specific to the current setting increased by a mean log odds of `r sprintf("%1.2f", cacc_results$fixed["drugplacebo","Estimate"])` (95% CI[`r sprintf("%1.2f", cacc_results$fixed["drugplacebo","l-95% CI"])`, `r sprintf("%1.2f", cacc_results$fixed["drugplacebo","u-95% CI"])`, Fig \ref{fig:caccfig}A&B) for the placebo session, relative to the dopamine session. This suggests that dopamine caused interference between settings.
