...
168
Humans often develop stereotypical ways of performing tasks, given sufficient exposure to a consistent task environment; for example, most people follow their own routine to search their home for their keys. Humans are also able to segregate such routines despite striking similarities in performed actions and task-settings; humans tend not to confuse the search for keys with other tasks conducted at home, such as looking for the remote control. Our success in forming and segregating routines is presumably underpinned by association of successful actions with the relevant task and situational cues [@sutton2018reinforcement]. Although the putative computational underpinnings of this process are relatively well characterised [@joelActorcriticModelsBasal2002; @montagueComputationalRolesDopamine2004 @sutton2018reinforcement; @fristonDopamineAffordanceActive2012], it remains to be understood why humans vary wildly in their capacity to form successful routines across task settings; a rigid adherence to learned routines in the face of changing task-settings and outcomes is thought to contribute to a range of pathologies and maladaptive behaviour patterns [@verhoevenRoleHabitsMaladaptive2018; @giommiFlexibleSelfPsychopathology2023]. 

230
Here we sought to investigate the impact of systemic dopamine availability and trait-mindfulness on performance in a novel task environment that allowed the formation of task-relevant routines. Dopamine availability and mindfulness may appear disparate, but there is evidence to suggest that the two are linked to the learning and task-switching processes that support routine formation and segregation. Firing rates in the caudate nucleus, which are modulated by dopamine release [@nakamuraRoleDopaminePrimate2006a; @mclennanActionDopamineNeurones1967], covary with the extent to which an eye-movement sequence deviates from the average used to attain reward [@desrochersOptimalHabitsCan2010; @desrochersHabitLearningNaive2015], suggesting a role for dopamine in the cost functions that guide routine learning. Lower trait mindfulness has been associated with a stronger tendency to exploit sequential stimulus information in stimulus-response tasks [@stillmanDispositionalMindfulnessAssociated2014], suggesting a relationship between mindfulness and sensitivity to environmental statistics that enable routine responding. Dopamine and mindfulness have also each been linked to the situational activation of appropriate repertoires; changes to the firing rates of dopaminergic outputs from songbird Area X correspond to changes in repertoires induced by situational cues [@budzilloDopaminergicModulationBasal2017], whereas lower mindfulness increases reliance on past behaviours when stimuli are conserved across tasks that carry different cognitive demands [@greenbergMindTrapMindfulness2012; @kuoResetTaskSet2015; @mehtaImpairedSetshiftingDissociable2004]. Although this evidence suggests that both systemic dopamine and mindfulness modulate the formation and situational activation of successful behavioural routines, we know little about how the two may be related with regard to their influence.

There are existent theoretical frameworks that guide hypotheses regarding how dopamine availability and mindfulness may jointly confer influence on the formation and deployment of task-relevant routines. In the case of simple operant responses, higher levels of dopamine transmission elevates the probability that cortical inputs trigger action selection [], and mediates a more rapid shift to habitual styles of responding []. Higher mindfulness increases sensitivity to dynamics in reinforcement contingencies [] as well as reduced variability in the cortical correlates assumed to underpin their representation []. Therefore, mindfulness may promote the transmission of a better model of the task environment via corticostriatal connections, resulting in the reinforcement of optimal task-relevant habits. Relatedly but assuming differing computational underpinnings, dopamine signalling [@fristonDopamineAffordanceActive2012; @fitzgeraldDopamineRewardLearning2015] and mindfulness [@lutzEpistemicPragmaticValue2019; @laukkonenManyOneMeditation2021] have each been associated with increases certainty regarding predictions of future internal states. According to this view, increasing dopamine availability should instill false inference regarding which actions led to rewarding outcomes [@fitzgeraldDopamineRewardLearning2015] leading to suboptimal behaviour. In contrast, mindfulness is 

PRESUMED ADD THE DEPENDENCE OF MINDFULNESS ON DA IS UNKNOWN the impact of which is moderated by the relationship between mindfulness and appropriate precision setting across levels of task hierarchies [@laukkonenManyOneMeditation2021]. Thus higher mindfulness should potentially rescue one from the deleterious impact of elevated dopamine on the deployment of task-relevant routines. 



Thus mindfulness may influence the quality of response-reward representations available for association with dopamine driven value information, suggesting a dependence of mindfulness on the accuracy of representations that are tagged as rewarding under conditions of elevated dopamine signalling.

Greedy parameter DA
https://elifesciences.org/articles/51260
https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4443960/
Greedy parameter mind
@keePowerNowBrief2013

Yet the quantitative impact of the two is unclear. It could be that both boost at all levels of the hierarchy (e.g. Friston/Reuben). It could be that the relationship is dependent on mindfulness - current contents and reinforcement. Also S-R links may be made independent of mindfulness, while only task switching is impacted.

Sought to provide this quantification to inform theoretical understanding. Did this stuff.

Offcuts:
Firing rates of dopaminergic cells in ventral tegmental area covary with reward prediction errors (PE) that signal the success of chosen actions [@schultz1997neural], whereas mindfulness practice attenuates PE-like signals in the putamen, measured using blood-oxygen-level-dependent (BOLD) signal [@kirkMindfulnessMeditationModulates2015; @kirkShorttermMindfulnessPractice2019]. 
