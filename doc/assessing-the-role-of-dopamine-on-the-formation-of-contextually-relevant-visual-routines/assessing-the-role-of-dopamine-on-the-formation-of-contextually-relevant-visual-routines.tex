...
average 0.64 (95\% CI {[}0.63, 0.65{]}) for the DA session, and 0.65
(95\% CI {[}0.64, 0.66{]}) for the placebo session. The log-odds of
...
the course of the sessions; mean accuracy in block 1 was 0.57 (95\%
CI{[}0.55, 0.59{]}), relative to a block 8 mean of 0.70 (95\% CI{[}0.68,
0.72{]}). The model showed that contextual accuracy increased by a mean
...
were positively related (\(r\mathrm{(}\) 37 \(\mathrm{)}\)

We sought to determine whether these opposing effects could be
attributed to the same underlying factor, such as an overall
accuracy/stereotypy trade-off. A correlation analysis on the mean
accuracy and stereotypy data did not support this idea, instead accuracy
and stereotypy were positively correlated (insert test here). This
suggests that the opposing pattern of results cannot be simply
attributed to a general accuracy/stereotypy trade off in the data. To
further rule this out, we added accuracy scores as a regressor to the
winning stereotypy model. Adding accuracy scores served to increase the
estimated drug x mindfulness interaction ()
