...
Having established the best model to account for the data, we next
determine the influence of DA and mindfulness on accuracy by making
inference over the resulting parameters. DA reduced contextual accuracy;
the log-odds of performing a contextual accurate target door selection
increased in the placebo session (mean log odds = 0.07, 95\% CI{[}0.01,
0.13).

In demonstration that participant learned to make contextually accurate
target door locations over the course of the sessions, contextual
accuracy reliably increased over blocks (mean log odds = 0.13, 95\%
CI{[}0.07, 0.19, Fig XX). Mindfulness did not have a reliable impact on
contextual accuracy (mean log odds = 0.04, 95\% CI{[}-0.04, 0.15, Fig
XX).
