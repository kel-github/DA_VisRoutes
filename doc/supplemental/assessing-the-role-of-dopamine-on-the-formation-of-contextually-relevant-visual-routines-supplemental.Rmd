...
acc_mods <- tibble(model = c("fx-b+drg_rfx-b+drg", "fx-b x drg_rfx-b+drg", "fx-b+drg_rfx-b", "fx-b x drg_rfx-b", "rfx-b", "fx-b_rfx-b", "fx-b"),
                   elpd_diff = c(0.0, -0.2, -674.1, -674.8, -677.8, -679.3, -1224.6),
                   se_diff = c(0.0, 0.5, 80.8, 80.5, 81.3, 81.7, 118.0))

acc_w_mind_mods <- tibble(model = c("m x b x drg + m", "b x m + m", "drg x m + m", "b x m + m", "+ m", "b + drg"),
                          elpd_diff = c(0.0, 0.0, -0.2, -11.8, -11.9, -12.0),
                          se_diff = c(0.0, 0.7, 0.8, 6.4, 6.4, 6.4))
